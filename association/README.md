...
This folder contains the analytical code shared on GitHub.
...
| `04_gdp_amr_inequality_analysis.R` | GDP-AMR SII/RII inequality analysis and manuscript tables. |
| `05_gbd_factor_decomposition_baseline.R` | Baseline-to-future GBD/Shapley three-factor decomposition with total uncertainty. |
...
- Script 05 reads a factor-input file normally produced by the adjacent-period
  GBD decomposition, which is not included in this repository. Only the
  baseline decomposition script is shared.
- `sa2_GDPpc_2000_2100_ssp123.feather` is required by script 04.
